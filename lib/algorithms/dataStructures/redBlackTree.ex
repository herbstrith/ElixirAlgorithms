defmodule Algorithms.DataStructures.RedBlackTree do
  ...
  defp balance(
         _nodeColor = :black,
         leftNode = %RBNode{color: :red, left: %RBNode{color: :red}},
         actualNode,
         rightNode
       ) do
    %RBNode{
      color: :red,
      left: %{leftNode.left | color: :black},
      key: leftNode.key,
      data: leftNode.data,
      right: %RBNode{
        color: :black,
  ...
  defp balance(
         _nodeColor = :black,
         leftNode = %RBNode{color: :red, right: %RBNode{color: :red}},
         actualNode,
         rightNode
       ) do
    %RBNode{
  ...
  defp balance(
         ...
         leftNode,
         actualNode,
         rightNode = %RBNode{color: :red, left: %RBNode{color: :red}}
       ) do
    %RBNode{
      color: :red,
      left: %RBNode{
  ...
  defp balance(
         ...
         leftNode,
         actualNode,
         rightNode = %RBNode{color: :red, right: %RBNode{color: :red}}
       ) do
    %RBNode{
      color: :red,
      left: %RBNode{
      ...
      key: rightNode.key,
      data: rightNode.data,
      right: %{rightNode.right | color: :black}
    }
  end
  ...
  defp balance(nodeColor, leftNode, actualNode, rightNode) do
    %RBNode{
      color: nodeColor,
      left: leftNode,
      key: actualNode.key,
    ...
    cond do
      actualTreeNode.key > newNode.key ->
        balance(
          ...
          insertRec(actualTreeNode.left, newNode),
          actualTreeNode,
      ...
      actualTreeNode.key < newNode.key ->
        balance(
          ...
          actualTreeNode.left,
          actualTreeNode,
          insertRec(actualTreeNode.right, newNode)
        )
    end
  end

  def delete(actualTreeNode = %RBNode{}, deleteKey) do
    result = deleteRec(redden(actualTreeNode), deleteKey)
    result
  end
  ...
  defp deleteRec(
    ...
    cond do
      actualTreeNode.key > deleteKey ->
        %{actualTreeNode |
         color: :black,
         left: deleteRec(actualTreeNode.left, deleteKey),
         right: nil}

      actualTreeNode.key == deleteKey ->
        %{actualTreeNode.left | color: :black, left: nil, right: nil}
    ...
    cond do
      actualTreeNode.key < deleteKey ->
        rotate(
          actualTreeNode.color,
          actualTreeNode.left,
          %{actualTreeNode | left: nil, right: nil},
  ...
  defp rotate(
         ...
         actualNode = %RBNode{},
         rightNode = %RBNode{color: :blackblack}
       ) do
    balance(
      :black,
      leftNode.left,
      %{leftNode | left: nil, right: nil},
  ...
  defp rotate(
         ...
         leftNode = %RBNode{color: :blackblack},
         actualNode = %RBNode{},
         rightNode = %RBNode{color: :red, left: %RBNode{color: :black}}
       ) do
    %{
      rightNode
      | color: :black,
        left:
          balance(
            ...
            %{
              actualNode
              | color: :red,
                left: %{leftNode | color: :black},
                right: rightNode.left.left
            },
            %{rightNode.left | left: nil, right: nil},
            rightNode.left.left
          )
    }
  end
      ...
      | color: :black,
        right:
          balance(
            :black,
            leftNode.right.left,
            %{leftNode.right | left: nil, right: nil},
            %{
              actualNode
              | color: :red,
                left: leftNode.right.right,
                right: %{rightNode | color: :black}
            }
          )
    }
  end
